...
import { InventoryCategory } from '../core/_models'
import { useAuth } from '../../auth'

interface HeadModalProps {
  visible: boolean
  onClose: () => void
  onSubmit: (payload: { name: string; inventoryItemCategoryId: number }) => Promise<void>
}

const HeadModal: FC<HeadModalProps> = ({ visible, onClose, onSubmit }) => {
      ...
      <div className='modal-dialog modal-dialog-centered' role='document'>
        <div className='modal-content bg-white'>
          <div className='modal-header border-bottom'>
            <h3 className='modal-title fw-bold text-dark'>Add New Head</h3>
