...
type AuditFindingAttachmentsModalProps = {
  visible: boolean
...
const AuditFindingAttachmentsModal: FC<AuditFindingAttachmentsModalProps> = ({
  visible,
  findingLabel,
  loading,
  items,
    ...
    <div style={WRAP_STYLE} onClick={handleBackdropClick}>
      ...
      >
        ...
        <div className='d-flex justify-content-between align-items-center border-bottom px-4 py-3'>
          <div>
            <h5 className='mx-6 mt-6'>Audit Finding Attachments</h5>

            <div className='d-flex align-items-center gap-4 mx-6'>
              {findingLabel && (
                <small className='text-muted'>
                  Audit Finding:&nbsp;<strong>{findingLabel}</strong>
                </small>
              )}
...
export default AuditFindingAttachmentsModal
