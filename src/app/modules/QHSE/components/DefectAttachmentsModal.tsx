...
type DefectAttachmentsModalProps = {
  visible: boolean
...
const DefectAttachmentsModal: FC<DefectAttachmentsModalProps> = ({
  visible,
  defectNumber,
  loading,
  items,
    ...
    <div style={WRAP_STYLE} onClick={handleBackdropClick}>
      ...
      >
        ...
        <div className='d-flex justify-content-between align-items-center border-bottom px-4 py-3'>
          <div>
            <h5 className='mx-6 mt-6'>Defect Attachments</h5>

            <div className='d-flex align-items-center gap-4 mx-6 '>
              {defectNumber && (
                <small className='text-muted'>
                  Defect No: <strong>{defectNumber}</strong>
                </small>
              )}
...
export default DefectAttachmentsModal
