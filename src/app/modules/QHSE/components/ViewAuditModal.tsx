...
import { AuditDto } from '../core/_models'
...
export const ViewAuditModal: FC<Props> = ({visible, onClose, record}) => {
  if (!visible || !record) return null

  const auditDateLabel =
    record.auditFromDate === record.auditToDate
      ? record.auditFromDate
      : `${record.auditFromDate} → ${record.auditToDate}`
        ...
        >
          ...
          <div className='modal-body' style={{maxHeight: '80vh', overflowY: 'auto'}}>
            <div className='row g-3'>
              ...
              <div className='col-md-6'>
                <label className={LABEL_CLS}>Audit</label>
                <div className='form-control-plaintext'>
              ...
              <div className='col-md-6'>
                <label className={LABEL_CLS}>Audit Type</label>
                <div className='form-control-plaintext'>
                  {record.auditType?.replace('_', ' ') || '-'}
                </div>
              </div>

              <div className='col-md-6'>
                <label className={LABEL_CLS}>Audit Date</label>
                <div className='form-control-plaintext'>
                  {auditDateLabel || '-'}
                </div>
              </div>
