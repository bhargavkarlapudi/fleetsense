...
const ConfirmOverwriteModal: React.FC<Props> = ({ onClose, isOpen, formData, assignmentId, selectedReport, selectedVoyage, onSaveDraft, actionType, onSubmitReport }) => {
        ...
        <div className="modal-overlay">
            <div className="modal-content" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="custom-modal-body">
                    ...
                    <div className='text-center'>Are you sure you want to overwrite the details?</div>
                </div>

                <div className="d-flex justify-content-evenly gap-2">
                    <button className="btn btn_secondary" onClick={onClose}>No, cancel</button>
                    <button className="btn btn_success" onClick={() => {
                        if (actionType === 'draft') {
                            onSaveDraft();
