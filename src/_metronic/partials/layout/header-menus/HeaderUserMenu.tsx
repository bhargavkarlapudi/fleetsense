        ...
        <div className='menu-content d-flex align-items-center px-3'>
          ...
          <div className='d-flex flex-column'>
            <div className='d-flex flex-column align-items-center fs-5'>
              ...
              {/* Conditional Vessel info */}
              {roleId == 4 && (
                <>
                  <div className='text-dark mb-1' style={{fontSize: '1.1rem'}}>
                     {rank}
                  </div>
                  <div className='text-dark fw-semibold fs-7 mb-1'>
                     {vesselname} | <span className='fs-7 fw-light'>{imoNumber}</span>
                  </div>
                </>
              )}
            </div>
